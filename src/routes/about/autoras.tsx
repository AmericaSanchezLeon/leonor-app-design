...
function SocialIcon({
  ...
  return (
    <a
      ...
      className={
        badge
          ? "flex h-6 w-6 items-center justify-center rounded-md transition hover:opacity-80"
          : "transition hover:opacity-70"
      }
      style={
        badge
          ? { backgroundColor: "var(--section-color)", color: "var(--leonor-cream)" }
                    ...
                    {(a.correo || a.linkedin || a.github) && (
                      <div className="mt-3 flex items-center gap-3">
                        ...
                        {a.linkedin && (
                          <SocialIcon
                            href={a.linkedin}
                            label={`Link de LinkedIn de ${a.autora}`}
                            badge
                          >
